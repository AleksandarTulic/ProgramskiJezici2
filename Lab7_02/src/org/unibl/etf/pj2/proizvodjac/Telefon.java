...
public class Telefon extends Proizvod implements Serializable {
    ...
    public Telefon(String password, double cost, String name, Proizvodjac user, String conf, String model){
        super(password, cost, name, user);
        this.conf = conf;
        this.model = model;
    }

    public Telefon(String password, double cost, String name, String name1, String country, String email, String conf, String model){
