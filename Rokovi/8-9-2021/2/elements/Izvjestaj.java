...
public class Izvjestaj {
	...
	public static void priprema() {
		...
		String res7 = arr.stream().map(t -> String.valueOf(t.getGodinaRod())).distinct().reduce("", (a, b) -> a + "#godina" + b);
		System.out.println(res7);
		
		System.out.println("OSMI DIO ============================================");
		arr.stream().sorted(
				Comparator.comparing(Student::getPrezime, Comparator.reverseOrder())
